  ...
  return (
    <div className="min-h-screen text-slate-100 flex items-center justify-center p-4 sm:p-6 lg:p-10 relative overflow-hidden bg-[#080c14] selection:bg-cyan-500 selection:text-white">
      ...
      <div className="max-w-5xl w-full mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        ...
        <div className="lg:col-span-5 hidden lg:flex flex-col justify-between space-y-6 p-8 rounded-3xl bg-slate-900/80 border border-cyan-500/30 shadow-2xl backdrop-blur-xl relative overflow-hidden">
        ...
        <div className="lg:col-span-7">
          <div className="glass-panel rounded-3xl p-6 sm:p-8 lg:p-9 border border-cyan-500/40 shadow-2xl backdrop-blur-xl relative overflow-hidden bg-slate-900/85">
            {/* Ambient Corner Glow */}
